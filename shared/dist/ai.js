...
export function buildEmbedText(s) {
...
export function buildSummaryMessages(s) {
    const system = 'Eres un analista de contratación pública en Colombia. Devuelve SOLO JSON válido, sin texto fuera del objeto y sin envoltura en bloques de código.';
...
export function floatVectorToBlob(v) {
